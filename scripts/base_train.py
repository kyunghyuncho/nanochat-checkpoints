...
parser.add_argument("--n-embd-override", "--n_embd_override", type=int, default=None, help="override the default scaling law for n_embd")
...
parser.add_argument("--embedding-lr-override", "--embedding_lr_override", type=float, default=None, help="override learning rate for embedding parameters (Adam)")
parser.add_argument("--unembedding-lr", type=float, default=0.004, help="learning rate for unembedding parameters (Adam)")
parser.add_argument("--unembedding-lr-override", "--unembedding_lr_override", type=float, default=None, help="override learning rate for unembedding parameters (Adam)")
parser.add_argument("--weight-decay", type=float, default=0.2, help="cautious weight decay for the Muon optimizer (for weights)")
parser.add_argument("--matrix-lr", type=float, default=0.02, help="learning rate for matrix parameters (Muon)")
parser.add_argument("--matrix-lr-override", "--matrix_lr_override", type=float, default=None, help="override learning rate for matrix parameters (Muon)")
parser.add_argument("--scalar-lr", type=float, default=0.5, help="learning rate for scalars (resid_lambdas, x0_lambdas)")
parser.add_argument("--scalar-lr-override", "--scalar_lr_override", type=float, default=None, help="override learning rate for scalars (resid_lambdas, x0_lambdas)")
